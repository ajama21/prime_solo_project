...
router.post('/', rejectUnauthenticated,(req, res, next) => {
  ...
  pool
    .query(queryText, [req.body.make, req.body.year, req.body.model, req.body.image_link, req.body.truck_number, req.body.dispatcher_id])
    .then((response) => {
...
router.put('/:id', rejectUnauthenticated, (req, res) => {
    ...
    WHERE "id"=$6; `;
    pool
      .query(query, [req.body.make, req.body.year, req.body.model, req.body.image_link, req.body.truck_number,req.params.id])
      .then((result) => {
        res.send(result.rows);
      })
      .catch((err) => {
